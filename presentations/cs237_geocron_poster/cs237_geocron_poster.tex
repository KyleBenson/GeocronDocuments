...
\lIf{$RegionsAttempCount (region_count)$} {$likelihood = 0$\;}
...
\scriptsize
\Begin{
\tcc*[l]{Set maxDistance to a considerably large number}
...
\scriptsize
\Begin{
\tcc*[l]{Set minDistance to a considerably small number}
