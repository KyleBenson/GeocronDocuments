...
\begin{figure}
\includegraphics[height=\textwidth,angle=-90]{angular_path}
\caption{This heuristic select overlay node that has the closest distance to the source.}
\end{figure}
\end{column}
...
\begin{figure}
\includegraphics[height=\textwidth,angle=-90]{angular_path}
\caption{This heuristic select overlay node that has the furthest distance to the source.}
\end{figure}
\end{column}
