...
not so much a big problem in wired network, and the hop count issue could be ignored as well. Admittedly, problems like overhead introduced by node election, network convergence and so on, are universal regardless wired or wireless network. 
%
The location-based routing technique 
