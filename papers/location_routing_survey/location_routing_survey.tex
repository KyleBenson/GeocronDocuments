...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
Important earlier papers like \cite{Basagni1998} had laid out several import features regarding geocast protocol design, one of which is forwarding zone. In order to avoid flooding the whole ad hoc network, protocols like \cite{Basagni1998}, \cite{Camp2003}, \site{GEOGRID} and so on devide the network into several Forwarding Zones (FZ). Geocast messages would 
